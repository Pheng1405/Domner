...
const AddPost = () =>{
    ...
    const handleSubmit = async (e) =>{
        e.preventDefault();
        const data = {
            admin: JSON.parse(localStorage.getItem("access-token")).id,
            name,
            price,
            imageCover : cover,
            images : arrImage,
        ...
        try{
            ...
            postStatus  ? navigate('../posts') : navigate('./');
         }
        catch(e){
       ...
       <div className="container d-flex justify-content-center">
        <div className="col-12">
            <form className="container" onSubmit={handleSubmit}>
                ...
                {/* <!-- Submit button --> */}
                <button type="submit" className="btn btn-success btn-block mb-4" data-bs-dismiss="modal">Post</button>
            </form>
        </div>
       </div>
    );
