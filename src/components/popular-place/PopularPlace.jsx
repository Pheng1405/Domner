...
const PopularPlace = () =>{
    ...
    const PopularTour = async () =>{
        const  popularTourAPI = "https://domner-server.onrender.com/api/popular/limit=8";
        await axios
            .get(popularTourAPI)
            .then(result => {
            ...
            <div className="menu-items ps-5 pe-5 container mt-5 ">
                    ...
                    
                {
                        popular.map((element, index) =>(
                            // console.log(element)
                                <Link className="overflow-hidden col-12 col-md-6 col-lg-4 col-xl-3 p-0 mb-3" key={index} to={`attraction/${element.id}`}>
                                    
                                        <div className="menu-item">
                                            <div className="row">
                                                <div className="place-box mb-3">
                                                    <div className="w-100 h-50 overflow-hidden">
                                                        <img src={element.thumbnail} className="fit-cover img-hover" alt="" />
                                                    </div>
                                                        ...
                                                        <div className="container-fluid">
                                                            ...
                                                            <div className="row row pt-3 ps-3 pe-3 pb-0 m-0">
                                                                <div className="col-6 p-0">
                                                                    <h5 className="hover-underline fs-5">{element.title.substring(0,20)}</h5>
                                                                </div>
                                                            ...
                                                            <div className="row mt-2 ps-3">
                                                                <div className="col-12 d-flex align-items-center">
                                                                    <p className="p-0">Location : {element.zone}</p>
                                                                </div>
